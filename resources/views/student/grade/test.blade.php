...
<div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor">{{\Auth::user()->name}} Test Grade List</h3>
                        <ol class="breadcrumb">
    ...
    <h4 class="card-title">Test Grade List Export</h4>
        ...
        <table id="example24" class="display nowrap table  table-bordered" cellspacing="0" width="100%">
                                       <thead>
                                        ...
                                        <tbody>
               @foreach(\App\Testgrade::where('student_id',\App\Student::where('data_id',\Auth::user()->id)->first()->id)->get() as $class)
                                            <tr>
