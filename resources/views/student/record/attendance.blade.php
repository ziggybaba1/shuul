...
<div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor">{{\Auth::user()->name}} @lang('admin.attendance')</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('')}}/parent/page.fmp?page=1">@lang('admin.home')</a></li>
                            <li class="breadcrumb-item active">@lang('admin.attendance')</li>
                        </ol>
                    </div>
                     ...
                     <div class="col-sm-6">
                      ...
                      <label for="example-email">@lang('admin.pick-range') *<span class="help"></span></label>
                               <div class="input-daterange input-group" id="date-range">
                                                ...
                                                <input type="text" readonly placeholder="End Date" id="date-end" class="form-control" name="end" />
                                </div>
                        </div>
