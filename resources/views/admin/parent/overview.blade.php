...
@section('content')
    ...
    <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor">@lang('admin.pickup') @lang('admin.overview')</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('')}}/admin/page.fmp?page=1">@lang('admin.home')</a></li>
                            <li class="breadcrumb-item active">@lang('admin.pickup') @lang('admin.overview')</li>
                        </ol>
                    </div>
 ...
 <div class="row">
                 ...
                 <div class="alert alert-warning alert-rounded">{{ session('error') }}</div>
                    @endif
                        <div class="card card-body">
                            <h4 class="card-title">@lang('admin.student') @lang('admin.pickup') @lang('admin.status')</h4>
                            <h6 class="card-subtitle">@lang('admin.filter') @lang('admin.pickup') @lang('admin.overview')</h6>
    ...
    <div class="row">
            ...
            <option>@lang('admin.select') @lang('admin.student')</option>   
            </select>
                                </div>
                              </div>
                     <div class="col-sm-6">
