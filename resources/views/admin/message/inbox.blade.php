...
@section('content')
    <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor"> @lang('admin.intr_mail')</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('')}}/admin/page.fmp?page=1">@lang('admin.home')</a></li>
                            <li class="breadcrumb-item active">@lang('admin.intr_mail')</li>
                        </ol>
                    </div>
 ...
 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card-body inbox-panel"><a onclick="loadcont('{{url('')}}/show/compose','inbox')" href="javascript:void(0)" class="btn btn-danger m-b-20 p-10 btn-block waves-effect waves-light">@lang('admin.compose')</a>
                                        <ul class="list-group list-group-full">
                                            ...
                                            <li class="list-group-item " id="sent">
                                                <a onclick="loadcont('{{url('')}}/show/sent','sent')" href="javascript:void(0)"> <i class="mdi mdi-file-document-box"></i>@lang('admin.sent') @lang('admin.mail')  <span class="badge badge-success ml-auto">     {{count(\App\Messaging::where('send_id',\Auth::user()->id)->latest()->get())}}</span></a>
                                            </li>
                        ...
                        <table id="" class="table table-hover no-wrap customed">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>#</th>
