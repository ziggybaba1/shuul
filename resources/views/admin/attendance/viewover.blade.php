...
@section('content')
    ...
    <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor">@lang('admin.attend_over')</h3>
                        <ol class="breadcrumb">
 ...
 <div class="row">
                 ...
                 <div class="alert alert-warning alert-rounded">{{ session('error') }}</div>
                    @endif
                        <div class="card card-body">
                            <h4 class="card-title">@lang('admin.attendance-status')</h4>
                            <h6 class="card-subtitle">@lang('admin.attendance-filter')</h6>
    ...
    <div class="row">
            ...
            <option>@lang('admin.select_student')</option>   
            </select>
                                </div>
                              </div>
                     <div class="col-sm-6">
                      ...
                      <label for="example-email">@lang('admin.pick-range') *<span class="help"></span></label>
                               <div class="input-daterange input-group" id="date-range">
                                                <input type="text" id="date-start" placeholder="@lang('admin.start-date-time')" class="form-control" name="start" />
                                                <span class="input-group-addon bg-danger b-0 text-white">@lang('admin.to')</span>
                                                <input type="text" placeholder="@lang('admin.end-date-time')" id="date-end" class="form-control" name="end" />
                                </div>
                        </div>
                   ...
                   <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                               <h4 class="card-title m-t-40">@lang('admin.date-attend-status'):</h4>
        ...
        return {
            init: function() {
                    $("#paginator4").datepaginator({
                      ...
                      if(data=='1'){
                         swal("@lang('admin.present'), " + moment(t).format("Do, MMM YYYY"), "@lang('admin.continue-button')", "success");
                      }
                      if(data=='0'){
                         swal("@lang('admin.absent') " + moment(t).format("Do, MMM YYYY"), "@lang('admin.continue-button')", "error");
                      }
                      if(data=='2'){
                         swal("@lang('admin.attend-not-avail') " + moment(t).format("Do, MMM YYYY"), "@lang('admin.continue-button')", "error");
                      }
                      if(data=='3'){
