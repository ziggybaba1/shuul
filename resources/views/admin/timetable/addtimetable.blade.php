...
@section('content')
    ...
    <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">@lang('admin.set') @lang('admin.time_table')</h3>
                        <ol class="breadcrumb">
 ...
 <div class="row">
                 ...
                 <div class="alert alert-info alert-rounded">{{ session('message') }}</div>
                    @endif
                        <div class="card card-body">
                            <h4 class="card-title">@lang('admin.time_table')</h4>
                            <h6 class="card-subtitle">@lang('admin.set') @lang('admin.time_table') @lang('admin.by') @lang('admin.class')</h6>
    ...
    <div class="row">
       <div class="col-md-2"></div>
            ...
            <input type="hidden" id="searchvalue" value="2" name="">
