...
.modal-dialog {
    ...
    <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor">@lang('admin.lesson_note')</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('')}}/admin/page.fmp?page=1">@lang('admin.home')</a></li>
                            <li class="breadcrumb-item active">class-lesson-note</li>
                        </ol>
                    </div>
 ...
 <div class="row">
                 ...
                 <div class="alert alert-warning alert-rounded">{{ session('error') }}</div>
                    @endif
                        <div class="card card-body">
                            <h4 class="card-title">@lang('admin.class') @lang('admin.lesson_note')</h4>
                            <h6 class="card-subtitle">@lang('admin.get_lesson_note')</h6>
    ...
    <div class="row">
         <div class="col-md-2"></div>
            ...
            <input type="hidden" id="searchvalue" value="11" name="">
