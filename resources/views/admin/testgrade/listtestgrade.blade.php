...
@section('content')
   ...
   <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Test Grade List</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Test Grade List Export</h4>
                                <h6 class="card-subtitle">Export data to Copy, CSV, Excel, PDF & Print</h6>
                                 <div class="pull-right">
                                 <button onclick="showAjaxModal('{{url('')}}/add/test-grade')" class="btn btn-primary btn-bg">Add New Test Grade</button>
                             </div>
        ...
        <table id="example23" class="display nowrap table  table-bordered" cellspacing="0" width="100%">
                    ...
                    <td>{{count(\App\Student::where('class',$class->id)->get())}}</td>
                     <td><button onclick="showAjaxModal('{{url('')}}/check/class-grade?class={{$class->id}}')" class="btn btn-primary btn-sm btn-block"><i class="fa fa-eye"></i></button></td>
                                            </tr>
                        @endforeach
                                        </tbody>
                </table>
