<div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            	<h4 class="card-title">{{\App\Teacher::find(\App\Award::find($id)->user_id)->gname}} {{\App\Teacher::find(\App\Award::find($id)->user_id)->fname}} Award Detail</h4>
                            <h6 class="card-subtitle">@lang('admin.award_detail')</h6>
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-badge success">
@if(\App\Teacher::find(\App\Award::find($id)->user_id)->image!='')
                                       <img class="img-responsive" alt="user" src="{{url('')}}/uploads/avatars/{{\App\Teacher::find(\App\Award::find($id)->user_id)->image}}" alt="img"> 
                                       @else
