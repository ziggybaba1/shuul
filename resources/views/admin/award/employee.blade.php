...
@section('content')
    ...
    <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">@lang('admin.staff_award')</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">@lang('admin.home')</a></li>
                            <li class="breadcrumb-item active">@lang('admin.staff_award')</li>
                        </ol>
                    </div>
...
<div class="pull-right">
    <button onclick="showAjaxModal('{{url('')}}/add/employee_award')" class="btn btn-primary btn-block btn-bg">@lang('admin.new_staff_award')</button>
</div>
    </div>
</div>
</div> 
 ...
 <div class="row">
    ...
    @forelse($employee as $stud)
    @if(count(\App\Award::where('user_id',$stud->id)->where('status','1')->get())>0)
                 ...
                 @endif
                                ...
                                <div class="col-md-8 col-lg-9">
                                    ...
                                    <address>
                                        ...
                                        <br/>
                             <div class="row">
                            @foreach(\App\Award::where('user_id',$stud->id)->where('status','1')->get() as $award)
                            <center>
                <a href="javascript:void(0)" onclick="showAjaxModal('{{url('')}}/show/eaward/{{$award->id}}')"><i class="fa fa-2x fa-trophy"></i></a><br>
        ...
        @endif
        @empty
        <h3 class="text-themecolor">@lang('admin.no_award')</h3>
                    <!-- /.col -->
@endforelse
                    </div> 
                    </div>
