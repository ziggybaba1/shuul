<div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card card-body">
                            <h4 class="card-title">@lang('admin.new_employee_award')</h4>
                            <h6 class="card-subtitle">@lang('admin.add_award')</h6>
<form class="" action="{{url('')}}/award/employee/create" enctype="multipart/form-data" method="post">
     {{ csrf_field() }}
                             <div class="form-group">
            <label for="example-email">@lang('admin.select_staff') *<span class="help"></span></label>
     <select required class="form-control select2" name="user_id">
         <option value="">@lang('admin.select_staff')</option>
