               ...
               <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('')}}/admin/page.fmp?page=62">@lang('admin.topic_list')</a></li>
...
<div class="row">
                    <div class="col-12">
                       ...
                       @foreach(\App\Response::where('thread_id',$id)->latest()->simplePaginate(20) as $online)
                                            <li>
