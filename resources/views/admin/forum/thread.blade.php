               ...
               <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('admin.forum') @lang('admin.topic')</li>
                        </ol>
                    </div>
 ...
 <div class="row">
                 ...
                 <div class="alert alert-info alert-rounded">{{ session('message') }}</div>
                    @endif
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">@lang('admin.forum') @lang('admin.topic') @lang('admin.export')</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                        @foreach(\App\Thread::all() as $class)
                                            <tr>
                                                <td>{{$loop->iteration}}</td>
                                                <td>{{$class->title}}</td>
                                                <td>{{\App\Forum::find($class->forum_id)->title}}</td>
                                                <td>{{$class->name}}</td>
          ...
          <script type="text/javascript">
              ...
              if(data==0){
                  swal("@lang('admin.account_delete')", "@lang('admin.continue-button')", "success");
                    window.location.assign('{{url('')}}/admin/page.fmp?page=62');
                }
            else{
