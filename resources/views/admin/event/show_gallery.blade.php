                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="{{url('')}}/uploads/gallery/{{$gallery->image}}" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="el-info">
                                            ...
                                            <li><a class="btn default btn-outline" onclick="deletegallery('{{$gallery->id}}')"><i class="fa fa-trash"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
         ...
         function deletegallery(id)
              {
                ...
                $.get('{{url('')}}/delete/gallery/'+id,function(data)
                {
                if(data==0){
                  swal("@lang('admin.account_delete')", "@lang('admin.continue-button')", "success");
                    window.location.assign('{{url('')}}/admin/page.fmp?page=45');
                }
            else{
