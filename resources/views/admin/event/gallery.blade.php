...
<div class="row el-element-overlay">
                    <div class="col-md-12">
                      <div class="row">
                        ...
                        <div class="col-md-12">
                       <div class="pull-left">
                        <button onclick="showAjaxModal('{{url('')}}/addn/event/category')" type="button" onclick="" class="btn btn-primary btn-rounded" >@lang('admin.add_event_cat')</button>
                    </div>
                        <div class="pull-right">
                        <button onclick="showAjaxModal('{{url('')}}/add/event/gallery')" type="button" onclick="" class="btn btn-info btn-rounded" >@lang('admin.add_event')</button>
                    </div>
                  </div> 
                  </div>
                    <hr>
                ...
                <span class="input-group-addon bootstrap-touchspin-prefix">/</span>
                 <input style="width: 100%;" value="{{\Carbon\Carbon::today()->subYear(-1)->format('Y')}}" type="text" id="last_session" class="form-control emdate" name="">
                   ...
                   <button onclick="geturl()" class="input-group-addon bootstrap-touchspin-prefix">@lang('admin.search')</button>
                     </span>
                  </div>
                        </div>
                      </div>
...
var category=$('#category').val();
       $.get('{{url('')}}/sort/gallery/'+first_session+'/'+last_session+'/'+category, function(data, status){
        if(status == "success")
        {
