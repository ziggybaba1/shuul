...
<div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">@lang('parent.attendance')</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('')}}/parent/page.fmp?page=1">@lang('parent.home')</a></li>
                            <li class="breadcrumb-item active">@lang('parent.attendance')</li>
                        </ol>
                    </div>
 ...
 <div class="row">
    ...
    <div class="row">
       ...
       <div class="col-md-2"></div>
            ...
            <input type="hidden" id="searchvalue" value="3" name="">
