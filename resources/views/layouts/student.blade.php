                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                           <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 @if(\App\Student::where('data_id',\Auth::user()->id)->first()->image=='')
                                  <img src="{{url('')}}/assets/images/user.png" alt="user" class="profile-pic" />
                                   @else
        <img src="{{url('')}}/uploads/avatars/{{\App\Student::where('data_id',\Auth::user()->id)->first()->image}}" alt="user" class="profile-pic" />
        @endif
                ...
                @else
                 <img src="{{url('')}}/uploads/avatars/{{\App\Student::where('data_id',\Auth::user()->id)->first()->image}}" alt="user">
                @endif
                                            </div>
                                            <div class="u-text">
                                                <h4>{{\Auth::user()->name}}</h4>
        <p class="text-muted">{{\Auth::user()->email}}</p><a href="{{url('')}}/student/page.fmp?page=18" class="btn btn-rounded btn-danger btn-sm">@lang('admin.view') @lang('admin.profile')</a></div>
                                        </div>
                                    </li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
    <a href="{{url('')}}/admin/page.fmp?page=1"><i class="mdi mdi-gauge"></i><span >@lang('admin.dashboard') </span></a>
                        </li>
                          <li>
...
<li><a href="{{url('')}}/student/page.fmp?page=2" >@lang('admin.result')</a></li>
@endif
<li><a href="{{url('')}}/student/page.fmp?page=3" >@lang('admin.routine')</a></li>
@if(\App\Support::first()->syl=='1') 
<li><a href="{{url('')}}/student/page.fmp?page=4" >@lang('admin.syllabus')</a></li>
@endif
@if(\App\Support::first()->less=='1') 
<li><a href="{{url('')}}/student/page.fmp?page=5" >@lang('admin.lesson_note')</a></li>
@endif
</ul>
</li>
@if(\App\Support::first()->etest=='1') 
 <li>
        <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-book"></i>CBT</a>
                                    <ul aria-expanded="false" class="collapse">
                <li><a href="{{url('')}}/student/page.fmp?page=19">@lang('admin.take_test')</a></li>
                <li><a href="{{url('')}}/student/page.fmp?page=20">@lang('admin.test') @lang('admin.history')</a></li>              
                                    </ul>
                                </li>
                                @endif
            <li>
        <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">@lang('admin.record')</span></a>
                            <ul aria-expanded="false" class="collapse">
                              @if(\App\Support::first()->att=='1') 
                <li><a href="{{url('')}}/student/page.fmp?page=6" >@lang('admin.attendance') @lang('admin.overview')</a></li>
                @endif
                @if(\App\Support::first()->pick=='1')               
                <li><a href="{{url('')}}/student/page.fmp?page=7" >@lang('admin.pickup') @lang('admin.overview')</a></li> 
                @endif
                @if(\App\Support::first()->awa=='1') 
                <li><a href="{{url('')}}/student/page.fmp?page=8" >@lang('admin.award')</a></li> 
                @endif
                            </ul>
                        </li>
    <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">@lang('admin.resource')</span></a>
                ...
                @if(\App\Support::first()->lib=='1')   
                                <li><a href="{{url('')}}/student/page.fmp?page=9">@lang('admin.book') @lang('admin.order')</a></li>
                                @endif
                                @if(\App\Support::first()->book=='1') 
                                <li><a href="{{url('')}}/student/page.fmp?page=10">@lang('admin.book') @lang('admin.sale')</a></li>
                                @endif
    ...
    <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">@lang('admin.account')</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('')}}/student/page.fmp?page=11">@lang('admin.school') @lang('admin.fee') @lang('admin.payment')</a></li>
                                @if(\App\Support::first()->book=='1') 
                                <li><a href="{{url('')}}/student/page.fmp?page=12">@lang('admin.book') @lang('admin.payment')</a></li>
                                @endif
                            </ul>
        </li>
        @if(\App\Support::first()->event=='1') 
                                  <li><a href="{{url('')}}/student/page.fmp?page=16"><i class="fa fa-calendar"></i> @lang('admin.event')</a></li>
                                  @endif
                                  @if(\App\Support::first()->gall=='1') 
                                   <li><a href="{{url('')}}/student/page.fmp?page=22"><i class="fa fa-file"></i> @lang('admin.gallery')</a></li>
                                   @endif
                                   @if(\App\Support::first()->forum=='1') 
                                   <li><a href="{{url('')}}/student/page.fmp?page=15"><i class="mdi mdi-message"></i> @lang('admin.forum')</a></li>
                                   @endif
                                    <li><a href="{{url('')}}/student/page.fmp?page=21"><i class="fa fa-inbox"></i>@lang('admin.mailbox')<span class="badge badge-success pull-right">{{count(\App\Messaging::where('receive_id',\Auth::user()->id)->where('status','1')->get())}}</span></a></li>
                    </ul>
                </nav>
