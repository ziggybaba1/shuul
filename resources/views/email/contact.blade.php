...
<head>
  ...
  <title>@lang('admin.contact') @lang('admin.replies')</title>
</head>
...
<img style="width: 200px;" src="{{url('')}}/uploads/avatars/{{\App\Provider::first()->logo}}" style="display:inline-block;" />
					</p>
      ...
      <tr>
                ...
                <p style="text-align:center;margin:0;padding:0;">
                  <div class="backon" style="background-color:#545454;text-align:center;margin:5px;padding:5px;display:block;">
                   <h4 style="color: white;text-align: center;"> {{\App\Provider::first()->name}}</h4>
                  </div>
      ...
      <tr>
				<td align="center" valign="top">
                  ...
                  <h3>@lang('admin.hello') --{{ $data1["cname"] }}--,</h3>
									<h2><strong>{{ $data1["title"] }}</strong></h2>
									<p>{{ $data1["message"] }}</p>
								</td>
							</tr>
						</table>
      ...
      <tr>
				<td align="center" valign="top">
                  ...
                  <a class="blue-btn" target="_blank" href="{{url('')}}/view/page.fmp?page=admission"><strong>@lang('admin.join_today')</strong></a>
								</td>
							</tr>
						</table>
						<!-- // END BODY -->
													...
													<tr>
														<td align="left" width="50" valign="top" mc:edit="footer_sigimage" style="margin:0;padding:0;">
															<p style="margin-bottom:10px"padding:0;display:block;>
																<img src="{{url('')}}/uploads/avatars/{{ $data1['img'] }}" style="display:block;" />
															</p>
														</td>
														...
														<td align="left" valign="top" mc:edit="footer_sig" valign="top" style="margin:0;padding-top:10px;line-height:1;">
															<h4><strong>{{ $data1["uname"] }}</strong></h4>
															<h5>{{ $data1["dept"] }}</h5>
														</td>
													</tr>
												</table>
						...
						<tr>
							<td valign="top" width="100%" mc:edit="footer_unsubscribe">
								<p style="text-align:center;">
									<img style="width: 70px;" src="{{url('')}}/uploads/avatars/{{\App\Provider::first()->logo}}" style="margin:0 auto 0 auto;display:inline-block;" />
								</p>
								<h6 style="text-align:center;margin-top: 9px;">{{\App\Provider::first()->name}}</h6>
								<h6 style="text-align:center;">{{\App\Provider::first()->address}}</h6>
